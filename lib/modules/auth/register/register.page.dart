...
class RegisterPage extends StatelessWidget {
      ...
      listener: (context, state) {
        ...
        switch (status.runtimeType) {
          case ErrorLogin:
            ...
            log('Error Register : ${(state.statusLogin as ErrorLogin).errorMsg}');
            break;
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                Text(_TEXT_REGISTER, style: _TEXT_STYLE_REGISTER),
                SizedBox(height: 40),
                _createEmail(),
                _createPassBtn(),
                SizedBox(height: 20),
                _createRegisterBtn(context),
                SizedBox(height: 20),
                Text(_TEXT_OTHER_REGISTER),
                SizedBox(height: 20),
  ...
  Widget _createRegisterBtn(BuildContext context) {
    return ElevatedButton(
      ...
      onPressed: () => _onRegisterHandle(
        context,
        txtControllerEmail.text,
        txtControllerPass.text,
      ),
      child: Container(
        child: Text(_TEXT_BUTTON_REGISTER, style: _TEXT_STYLE_BTN_REGISTER),
      ),
    );
  }
  ...
  Widget _createGoogleBtn(BuildContext context) {
    return ElevatedButton(
      ...
      onPressed: () => _onRegisterGoogleHandle(context),
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Container(
              height: 30,
              width: 30,
              child: Image.asset(_IMG_GOOGLE_REGISTER),
            ),
            SizedBox(width: 20),
            Container(
